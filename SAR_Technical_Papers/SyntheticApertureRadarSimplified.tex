...
The geometry of SAR is illustrated in Figure \ref{fig:sar_geometry}. In Figure \ref{fig:geometry_range_plane} the cross section along the range direction is shown (the range plane). The "look angle" is $\theta$ and $\psi$ is the beam width along the range direction. The beam width is,
\begin{equation}
\label{ }
